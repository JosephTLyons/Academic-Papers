...
I prefer to use `.txt` files for these academic papers when I can because the
formatting is preserved on GitHub.  If I want to center align or indent a
paragraph, I can without issue.  However, there are some papers that are more
elaborate and require me to embed images and such.  For these papers, I've opted
to use Markdown, despite the fact that formatting, such as indents and center
aligning, are not preserved in this file type.
